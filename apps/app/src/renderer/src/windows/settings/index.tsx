      ...
      case "general":
        return (
          <GeneralTab
            ...
            onPrintIntervalChange={(value) =>
              settings.updateSettings("printInterval", value)
            }
            familyFriendly={settings.familyFriendly}
            onFamilyFriendlyChange={(value) =>
              settings.updateSettings("familyFriendly", value)
            }
          />
        );
      case "appearance":
        return (
          <AppearanceTab
            ...
            onThemeChange={(value) =>
              settings.updateSettings("selectedTheme", value)
            }
          />
        );
      case "pricing":
        return (
          <PricingTab
            ...
            onPlanSelect={(value) =>
              settings.updateSettings("selectedPlan", value)
            }
          />
        );
      case "home":
